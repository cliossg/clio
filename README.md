...
![Section Index](docs/gallery/section-index.png)
<p align="right"><i><a href="docs/gallery/index.md">view gallery...</a></i></p>
...
See the [User Guide](docs/userguide/index.md) for installation, features, and detailed walkthroughs.
